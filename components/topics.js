...
function topics() {
    return (
        <div className=" bg-white font-play text-center pb-16"> 
            <p className="text-3xl py-10 xl:py-16 font-black">Select your Keyword</p>
            <div className="flex flex-col md:flex-row flex-wrap gap-6 xl:gap-24 justify-center items-center">        
    
                {/*Card for Tech Keyword*/}
                <div className="font-play xl:scale-110 bg-dark-background border-2 rounded-2xl">
                ...
                <div className="font-play xl:scale-110 bg-dark-background rounded-2xl border-2">
