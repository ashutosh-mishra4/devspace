    ...
    return (
        <div className="bg-orange">
            ...
            <div className="flex font-play flex-col pb-10 text-center md:flex-row border-b-2 border-black gap-8 md:gap-4 lg:gap-10 justify-center items-center">
                <div className="bg-white lg:hover:-translate-y-2 lg:hover:scale-110 border-2 w-72 px-14 md:p-24 md:px-4 h-52 md:h-40 md:w-60 lg:w-72 flex flex-col items-center justify-center rounded">
